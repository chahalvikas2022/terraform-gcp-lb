...
module "load_balancer" {
  source                  = "https://github.com/chahalvikas2022/terraform-gcp-lb.git"
  name                    = "dev-test"
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/chahalvikas2022/terraform-gcp-lb/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/chahalvikas2022/terraform-gcp-lb/blob/master/LICENSE) file for details.
...
| Name | Source                                                       | Version |
|------|--------------------------------------------------------------|---------|
| <a name="module_labels"></a> [labels](#module\_labels) | git::git@github.com:chahalvikas2022/terraform-gcp-labels.git | v1.0.0 |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo                                                                                                           | `string` | `"https://github.com/chahalvikas2022/terraform-gcp-lb"`                                                                                                                                                        | no |
