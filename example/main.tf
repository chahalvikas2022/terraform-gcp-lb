...
module "instance_template" {
  source               = "git::git@github.com:chahalvikas2022/terraform-gcp-vm-template-instance.git"
  name                 = "dev-template"
  environment          = "test"
  region               = "asia-northeast1"
...
module "instance_group" {
  source              = "git::git@github.com:chahalvikas2022/terraform-gcp-instance-group.git"
  region              = "asia-northeast1"
  hostname            = "dev-test"
